...
static constexpr auto qt_meta_stringdata_ZN6MainUIE = QtMocHelpers::stringData(
    "MainUI"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN6MainUIE[] = {
...
Q_CONSTINIT const QMetaObject MainUI::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6MainUIE.offsetsAndSizes,
    qt_meta_data_ZN6MainUIE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6MainUIE_t,
        // Q_OBJECT / Q_GADGET
...
void *MainUI::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6MainUIE.stringdata0))
